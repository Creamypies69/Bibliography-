...
st.image(profile_image_url, width=250, use_column_width=False)  # Set width to 250 pixels to match name tag
...
images = {
    ...
    "DREESMN HS": ["https://via.placeholder.com/300?text=DREESMNHS+Image+1", "https://via.placeholder.com/300?text=DREESMNHS+Image+2", "https://via.placeholder.com/300?text=DREESMNHS+Image+3"],
